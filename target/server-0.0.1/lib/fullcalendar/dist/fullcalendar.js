...
var DayTableMixin = FC.DayTableMixin = {
	...
	renderHeadDateCellHtml: function(date, colspan, otherAttrs) {
		...
		if(dayIDs[date.day()] == "sun"){
			styleCss = ' style="color: #ff4c4c;"';
		}else if(dayIDs[date.day()] == "sat"){
			styleCss = ' style="color: #7272e0;"';
		}
		return '' +
		'<th class="fc-day-header ' + view.widgetHeaderClass + ' fc-' + dayIDs[date.day()] + '"' + styleCss +
			(this.rowCnt == 1 ?
...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	renderNumberCellHtml: function(date) {
		...
		if(classes.join(' ').indexOf('fc-sun') > 1){
			styleCss = 'style="color: #ff4c4c;"';
		}else if(classes.join(' ').indexOf('fc-sat') > 1){
			styleCss = 'style="color: #7272e0"';
		}
		
		return '' +
			'<td class="' + classes.join(' ') + '" data-date="' + date.format() + '"' + styleCss+'>' +
				date.date() +
			'</td>';
	},
...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				'<div class="fc-content" style="color:white; font-size: 15px;">' +
					(this.isRTL ?
