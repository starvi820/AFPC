...
<html class="no-js">
	<div ng-app="AfpcApp">
		...
		<link rel='stylesheet' href='/lib/textAngular/css/textAngular.css'>
		<script src='/lib/textAngular/js/textAngular-rangy.min.js'></script>
		<script src='/lib/textAngular/js/textAngular-sanitize.min.js'></script>
		<script src='/lib/textAngular/js/textAngular.min.js'></script>
		<script src='/lib/textAngular/js/textAngularSetup.js'></script>
	    
		<script src="/apps/cAgent.js"></script>
		...
		<script src="/apps/controllers/cAgent/agent.js"></script>
		</head>
