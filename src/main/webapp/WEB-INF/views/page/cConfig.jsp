...
<html class="no-js">
	<div ng-app="AfpcApp">
		...
		<script src="/apps/cConfig.js"></script>
		...
		<script src="/apps/controllers/cConfig/licenseMgt.js"></script>
		<script src="/apps/controllers/cConfig/patchMgt.js"></script>
		<script src="/apps/controllers/cConfig/departMgt.js"></script>
		<script src="/apps/controllers/cConfig/adminMgt.js"></script>
		<script src="/apps/controllers/cConfig/historyMgt.js"></script>
		</head>
